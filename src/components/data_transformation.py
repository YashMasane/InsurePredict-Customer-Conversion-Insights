...
class DataTransformation:
    ...
    def _capping_outliers(self, df: pd.DataFrame):
        ...
        df['Annual_Premium'] = [
            i if i < 61000 else 61000 for i in df['Annual_Premium']]
        return df
    ...
    def initiate_data_transformation(self) -> DataTransformationArtifact:
        ...
        try:
            ...
            input_feature_train_df = self._drop_unnecessary_columns(
                input_feature_train_df)
            input_feature_train_df = self._map_columns(input_feature_train_df)
            input_feature_train_df = self._capping_outliers(
                input_feature_train_df)

            input_feature_test_df = self._drop_unnecessary_columns(
            ...
            logging.info(
                "Applying RepeatedEditedNearestNeighbours for handling imbalanced dataset.")
            ...
            logging.info(
                "RepeatedEditedNearestNeighbours applied to train-test df.")
...
if __name__ == "__main__":
    try:
        ...
        data_validation_artifact = DataValidationArtifact(
            ...
            validation_report_file_path="artifact/data_validation/validation_report.yaml"
        )
