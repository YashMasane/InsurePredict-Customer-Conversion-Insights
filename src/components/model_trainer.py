...
class ModelTrainer:
    def __init__(self, data_transformation_artifact: DataTransformationArtifact,
        ...
        self.model_parameters = read_yaml_file(file_path=MODEL_TRAINER_MODEL_CONFIG_FILE_PATH)
    ...
    def get_model_object_and_report(self, train: np.array, test: np.array) -> Tuple[object, object]:
        ...
        try:
            ...
            model = RandomForestClassifier(**self.model_parameters['random_forest'])
            ...
            model_report_dir = os.path.dirname(self.model_trainer_config.model_report_file_path)
